...
export const metadata: Metadata = {
  title: "Idee einreichen und validieren | IDEAA",
  description:
    "Füg deine Geschäftsidee ein und erhalte in unter zwei Minuten einen strukturierten Validierungsbericht.",
  alternates: { canonical: "/validieren" },
  // App-/Tool-Seite. Die SEO-Startseite ist die Landing Page auf /.
